...
def generate_mission_control():
  ...
  <defs>
    ...
    <style>
      .title {{ font: bold 22px 'Courier New', monospace; fill: #00ff9f; }}
      .subtitle {{ font: 14px 'Courier New', monospace; fill: #00b8ff; }}
      .label {{ font: 12px 'Courier New', monospace; fill: #8892b0; }}
      .value {{ font: bold 14px 'Courier New', monospace; fill: #e6f1ff; }}
      .status {{ font: bold 12px 'Courier New', monospace; }}
      .border {{ fill: none; stroke: #00ff9f; stroke-width: 2; }}
      .panel {{ fill: rgba(16, 20, 40, 0.8); stroke: #00b8ff; stroke-width: 1; }}
      @keyframes pulse {{
        0%, 100% {{ opacity: 1; }}
        50% {{ opacity: 0.6; }}
      }}
  ...
  <circle cx="320" cy="206" r="6" fill="#00ff9f"/>
  ...
  <circle cx="320" cy="286" r="6" fill="#00ff9f"/>
  ...
  <text x="420" y="100" class="title">☁️ CLOUD TOPOLOGY</text>
  
  <!-- Load Balancer -->
  <rect x="560" y="120" width="70" height="30" fill="#00b8ff" rx="3"/>
  <text x="575" y="140" style="font: bold 12px monospace; fill: #000;">LB</text>
  
  <!-- Kubernetes Clusters -->
  <rect x="485" y="170" width="50" height="40" fill="#326ce5" rx="3"/>
  <text x="495" y="193" style="font: bold 11px monospace; fill: #fff;">K8s</text>
  
  <rect x="575" y="170" width="50" height="40" fill="#326ce5" rx="3"/>
  <text x="585" y="193" style="font: bold 11px monospace; fill: #fff;">K8s</text>
  
  <rect x="665" y="170" width="50" height="40" fill="#326ce5" rx="3"/>
  <text x="675" y="193" style="font: bold 11px monospace; fill: #fff;">K8s</text>
  
  <!-- Databases -->
  <rect x="510" y="235" width="45" height="35" fill="#336791" rx="3"/>
  <text x="517" y="256" style="font: bold 10px monospace; fill: #fff;">DB</text>
  
  <rect x="600" y="235" width="45" height="35" fill="#336791" rx="3"/>
  <text x="607" y="256" style="font: bold 10px monospace; fill: #fff;">DB</text>
  
  <rect x="690" y="235" width="45" height="35" fill="#336791" rx="3"/>
  <text x="697" y="256" style="font: bold 10px monospace; fill: #fff;">DB</text>
  
  <!-- Connection lines -->
  <line x1="595" y1="150" x2="510" y2="170" stroke="#00ff9f" stroke-width="2"/>
  <line x1="595" y1="150" x2="600" y2="170" stroke="#00ff9f" stroke-width="2"/>
  <line x1="595" y1="150" x2="690" y2="170" stroke="#00ff9f" stroke-width="2"/>
  
  <line x1="510" y1="210" x2="532" y2="235" stroke="#00b8ff" stroke-width="2"/>
  <line x1="600" y1="210" x2="622" y2="235" stroke="#00b8ff" stroke-width="2"/>
  <line x1="690" y1="210" x2="712" y2="235" stroke="#00b8ff" stroke-width="2"/>
  ...
  <rect x="920" y="118" width="240" height="16" fill="#1a1b3a" stroke="#00b8ff" stroke-width="1" rx="8"/>
  ...
  <rect x="920" y="148" width="240" height="16" fill="#1a1b3a" stroke="#00b8ff" stroke-width="1" rx="8"/>
  ...
  <rect x="920" y="178" width="240" height="16" fill="#1a1b3a" stroke="#00b8ff" stroke-width="1" rx="8"/>
  ...
  <rect x="920" y="208" width="240" height="16" fill="#1a1b3a" stroke="#00b8ff" stroke-width="1" rx="8"/>
